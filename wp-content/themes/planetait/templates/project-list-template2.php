...
?>
 ...
 <div id="rev_slider_projekty-header_wrapper" class="rev_slider_wrapper fullwidth-container" data-alias="co-robimy-header" data-source="gallery" style="background:#ffffff; padding-bottom: 100px;">
			...
			<ul>
				...
				<li data-index="rs-<?=$num?>" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"
				 ...
				 data-param9="" data-param10="" data-description="">
					<!-- MAIN IMAGE -->
					<img src="<?= get_template_directory_uri() ?>/assets/images/transparent.png" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5"
					 class="rev-slidebg" data-no-retina>
					<!-- LAYERS -->

					<!-- LAYER NR. 1 -->
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-<?=$num?>-layer-1" data-x="['center','center','center','center']"
					 data-hoffset="['0','0','0','0']" data-y="['middle','middle','middle','middle']" data-voffset="['-140','-60','-100','-50']"
					 data-width="none" data-height="none" data-whitespace="nowrap" data-type="image" data-responsive_offset="on" data-frames='[{"from":"x:right(R);","speed":800,"to":"o:1;","delay":750,"ease":"Power4.easeOut"},{"delay":"wait","speed":800,"to":"x:left(R);","ease":"Power4.easeIn"}]'
					 data-textAlign="['left','left','left','left']" data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]"
					 data-paddingleft="[0,0,0,0]" style="z-index: 5;text-transform:left;">
						<img src="<?= get_template_directory_uri()?>/assets/images/macbookpro.png" alt="" data-ww="['900px','500px','500px','400px']" data-hh="['450px','300px','300px','240px']"
						 data-no-retina> </div>
					...
					<div class="tp-caption   tp-resizeme rs-parallaxlevel-2" id="slide-<?=$num?>-layer-11" data-x="['center','center','center','center']"
					 ...
					 data-paddingleft="[0,0,0,0]" style="z-index: 6;text-transform:left;">
						<img src="<?= get_the_post_thumbnail_url( $projekt->ID, 'large')?>" alt="" data-ww="['587px','327px','327px','263px']" data-hh="['315px','205px','205px','165px']"
						 data-no-retina> </div>
...
<script type="text/javascript">
			            var revapiprojektyheader,
			            revapiprojektyheader2,
			            revapiP,
                        tpPH,
                        tpjP,
                        tpPH2;
            (function() {            
    if (!/loaded|interactive|complete/.test(document.readyState)) document.addEventListener("DOMContentLoaded",LoadPH)
        else
        LoadPH();
    ...
    function LoadPH() {                
        if (tpPH===undefined) {
            ...
            if("off" == "on") tpPH.noConflict();        
        }
				if(tpPH("#rev_slider_projekty-header").revolution == undefined){
					revslider_showDoubleJqueryError("#rev_slider_projekty-header");
				}else{
					revapiprojektyheader = tpPH("#rev_slider_projekty-header").show().revolution({
						sliderType:"standard",
						...
						gridwidth:[1200,960,720,440],
						gridheight:[256,148,148,148],
						lazyType:"single",
