...
function project_generate_content() {
    ...
    $section_what_we_do; $section_achievements; $section_prog_languages; $section_about_us; $section_partners; 
    $page_projects; $page_refferences; $page_carrier; $page_contact;
...
function create_post_type_html5()
{
    ...
    register_post_type('section_main', 
        array(
        'labels' => array(
