                    ...
                    <div id="rrzt_109" class="rev_row_zone rev_row_zone_top" style="z-index: 23;">
                        ...
                        <div class="tp-caption  " id="slide-109-layer-1" data-x="100" data-y="100" data-width="['auto']" data-height="['auto']" data-type="row"
                            ...
                            <div class="tp-caption  " id="slide-109-layer-2" data-x="100" data-y="100" data-width="['auto']" data-height="['auto']" data-type="column"
                                ...
                                data-columnwidth="25%" data-verticalalign="top" data-margintop="[0,0,0,0]" data-marginright="[0,0,0,0]"
                            ...
                            <!-- LAYER NR. 4 -->
                            <div class="tp-caption  " id="slide-109-layer-3" data-x="310" data-y="" data-width="['auto']" data-height="['auto']" data-type="column"
                                data-responsive_offset="on" data-responsive="off" data-frames='[{"delay":"+1190","speed":300,"frame":"0","to":"o:1;","ease":"Power4.easeOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                                data-columnwidth="25%" data-verticalalign="top" data-margintop="[0,0,0,0]" data-marginright="[0,0,0,0]"
                                data-marginbottom="[0,0,0,0]" data-marginleft="[0,0,0,0]" data-textAlign="['inherit','inherit','inherit','inherit']"
                                data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                            ...
                            <!-- LAYER NR. 9 -->
                            <div class="tp-caption  " id="slide-109-layer-4" data-x="100" data-y="100" data-width="['auto']" data-height="['auto']" data-type="column"
                                data-responsive_offset="on" data-responsive="off" data-frames='[{"delay":"+2390","speed":300,"frame":"0","from":"opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                                data-columnwidth="25%" data-verticalalign="top" data-margintop="[0,0,0,0]" data-marginright="[0,0,0,0]"
                                data-marginbottom="[0,0,0,0]" data-marginleft="[0,0,0,0]" data-textAlign="['inherit','inherit','inherit','inherit']"
                                data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                            ...
                            <!-- LAYER NR. 14 -->
                            <div class="tp-caption  " id="slide-109-layer-5" data-x="100" data-y="100" data-width="['auto']" data-height="['auto']" data-type="column"
                                data-responsive_offset="on" data-frames='[{"delay":"+3590","speed":300,"frame":"0","from":"opacity:0;","to":"o:1;","ease":"Power3.easeInOut"},{"delay":"wait","speed":300,"frame":"999","to":"opacity:0;","ease":"Power3.easeInOut"}]'
                                data-columnwidth="25%" data-verticalalign="top" data-margintop="[0,0,0,0]" data-marginright="[0,0,0,0]"
                                data-marginbottom="[0,0,0,0]" data-marginleft="[0,0,0,0]" data-textAlign="['inherit','inherit','inherit','inherit']"
                                data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
                        ...
                        <!-- LAYER NR. 19 -->
                        <div class="tp-caption  " id="slide-109-layer-27" data-x="100" data-y="100" data-width="['auto']" data-height="['auto']"
                            ...
                            <div class="tp-caption  " id="slide-109-layer-28" data-x="100" data-y="100" data-width="['auto']" data-height="['auto']"
                                ...
                                data-columnwidth="100%" data-verticalalign="top" data-margintop="[0,0,0,0]" data-marginright="[0,0,0,0]"
                                data-marginbottom="[0,0,0,0]" data-marginleft="[0,0,0,0]" data-textAlign="['inherit','inherit','inherit','inherit']"
                                data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]" data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
	...
	var templateUrl = "<?= get_template_directory_uri() ?>";
            function onLoadfooter() {
                if (tpjfooter === undefined) {
                    ...
                    if ("off" == "on") tpjfooter.noConflict();
                }
                if (tpjfooter("#rs-footer-footer").revolution == undefined) {
                    revslider_showDoubleJqueryError("#rs-footer-footer");
                } else {
                    revapifooter = tpjfooter("#rs-footer-footer").show().revolution({
                        sliderType: "standard",
                        jsFileLocation: +"/js/lib/revolution/js/",
